<section class="md:px-16 xs:px-6 px-4 md:pb-16 pb-4 pt-6 md:pt-16">
	<div class="prose mx-auto">
		...
		<p>
			...
			collected and recorded by kudu.design and how we use it.
		</p>
		<p>
		...
		<p>
			...
			website with regards to the information that they shared and/or collect in kudu.design. This
		...
		<h2>Log Files</h2>
		<p>
			kudu.design follows a standard procedure of using log files. These files log visitors when
		...
		<p>
			...
			Beacons that are used in their respective advertisements and links that appear on kudu.design,
		...
		<p>
			Note that kudu.design has no access to or control over these cookies that are used by
		...
		<p>
			kudu.design does not knowingly collect any Personal Identifiable Information from children
